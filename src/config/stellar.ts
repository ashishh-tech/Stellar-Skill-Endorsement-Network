export const STELLAR_CONFIG = {
  ...
  contracts: {
    profileRegistry: process.env.NEXT_PUBLIC_PROFILE_REGISTRY_CONTRACT_ID || 'CBJWW2LMNRCW4ZDPOJZWKUDSN5TGS3DFKJSWO2LTORZHSMJQGAYDCTPH',
    endorsementEngine: process.env.NEXT_PUBLIC_ENDORSEMENT_ENGINE_CONTRACT_ID || 'CBJWW2LMNRCW4ZDPOJZWKRLOM5UW4ZKTNVQXE5CDN5XHI4TBMN2DDGAL',
  },
  testnetContracts: {
    profileRegistry: 'CBJWW2LMNRCW4ZDPOJZWKVDFON2G4ZLUKBZG6ZTJNRSVEZLHGAYTD3JG',
    endorsementEngine: 'CBJWW2LMNRCW4ZDPOJZWKVDFON2G4ZLUIVXGO2LOMVJW2YLSOQYDDOMD',
  }
} as const;
